        ...
        <>
            <div className=" w-2/3 h-2/3  bg-white  border-gray-300 shadow-lg rounded-lg overflow-hidden" style={{ top: '0', position: 'absolute', marginLeft: '20em', marginTop: '5em' }}>
                <div className="p-4 flex flex-col items-center">
                    <img src="/order-component-card.svg" alt="" />
            ...
            <Link href="/lernMore" className="absolute bottom-0 left-0 right-0 text-gray-600 underline text-center pb-4">Learn more about orders</Link>
        </>
    )
}
